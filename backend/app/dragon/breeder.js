...
class Breeder {
  ...
  // 2 incoming traits: matronTrait and patronTrait
  ...
  // GEnerate a random number in theat range.
  // If the number is less than the matron's char sum,
  // pick matron. Else, pick patron.
